...
function _0x122a() {
    ...
    while (!![]) {
        try {
            ...
            if (_0xc58481 === _0x2d8861) break;
            else _0x3b48c8['push'](_0x3b48c8['shift']());
        } catch (_0xacab7) {
...
const wrapElements = (_0x3012d5, _0x3358a9, _0xf0e41f) => {
    ...
    _0x3012d5[_0x39461d(0x1b0)](_0x59b3d6 => {
        ...
        _0x498b1f[_0x5adda8(0x1be)] = _0xf0e41f, _0x59b3d6[_0x5adda8(0x1c9)][_0x5adda8(0x1c1)](_0x498b1f), _0x498b1f[_0x5adda8(0x1c1)](_0x59b3d6);
    });
};
if (document[_0x6760b6(0x1b5)](_0x6760b6(0x19f))[_0x6760b6(0x1bd)]) {
    class Slider {#
        ...
        constructor(_0x57f877, _0x78ad1e = ![]) {
            ...
            this[_0xfad059(0x19d)] = _0x57f877, this[_0xfad059(0x1bb)] = _0x78ad1e, this['items'] = [...this['element'][_0xfad059(0x1b5)](_0xfad059(0x1ca))], this[_0xfad059(0x19e)] = this[_0xfad059(0x1c0)][_0xfad059(0x1cb)](_0xad97a6 => _0xad97a6[_0xfad059(0x1c4)](_0xfad059(0x1b9))), this[_0xfad059(0x1c0)][this['current']]['classList'][_0xfad059(0x1b6)](_0xfad059(0x1b7)), this[_0xfad059(0x19c)] = this[_0xfad059(0x1c0)]['length'], gsap['set']([this[_0xfad059(0x1c0)], this[_0xfad059(0x19e)]], {
        ...
        set[_0x6760b6(0x1b7)](_0x4e7d72) {
            ...
            if (this[_0x2c43d2(0x1a8)]) return ![];
            ...
            gsap['timeline']({
                ...
                'onComplete': () => {
                    ...
                    this[_0x1449f6(0x1c0)][_0x189e58][_0x1449f6(0x1be)][_0x1449f6(0x1a9)]('current'), this['items'][this[_0x1449f6(0x1b7)]][_0x1449f6(0x1be)][_0x1449f6(0x1b6)](_0x1449f6(0x1b7)), this[_0x1449f6(0x1a8)] = ![];
                }
            })['to'](_0x59f483, {
    ...
    titles[0x0][_0x6760b6(0x1be)]['add']('type__item--current'), titles[_0x6760b6(0x1b0)](_0x5bced2 => _0x5bced2[_0x6760b6(0x1a0)]['splitting'] = ''), Splitting();
    const chars = titles['map'](_0x22f656 => {
        const _0x5214f7 = _0x6760b6,
            _0x268022 = _0x22f656[_0x5214f7(0x1b5)](_0x5214f7(0x1a2));
        return wrapElements(_0x268022, 'span', _0x5214f7(0x1ac)), _0x268022;
    });
    gsap['set']([titles, chars], {
        'will-change': _0x6760b6(0x1b3)
    });
    const navigate = _0x1b2d85 => {
            toggleTitle(_0x1b2d85), sliderBG[_0x1b2d85](), sliderFG[_0x1b2d85]();
        },
        toggleTitle = _0x1889de => {
            const _0x2785a4 = _0x6760b6;
            if (sliderBG[_0x2785a4(0x1a8)]) return ![];
    ...
    navigation[_0x6760b6(0x1aa)]['addEventListener'](_0x6760b6(0x1c7), () => navigate(_0x6760b6(0x1aa))), navigation[_0x6760b6(0x1bc)][_0x6760b6(0x1ad)]('click', () => navigate('prev')), Observer['create']({
        'target': window,
