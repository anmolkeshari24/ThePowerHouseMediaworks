...
(function($) {
    ...
    if ($(tpSideMenu).find('.submenu, .mega-menu').length != 0) {
        $(tpSideMenu).find('.submenu, .mega-menu').parent().append('<button class="tp-menu-close"><i class="fa-solid fa-plus"></i></button>');
    }
    ...
    function tp_text_invert() {
        const split = new SplitText(".tp_text_invert", {
            type: "lines"
        });
    ...
    function tp_text_invert_2() {
        const split_2 = new SplitText(".tp_text_invert_2", {
            type: "lines"
        });
    ...
    function tp_text_invert_3() {
        const split_3 = new SplitText(".tp_text_invert_3", {
            type: "lines"
        });
    ...
    if (document.querySelectorAll('.design-work-wrapper')) {
        ...
        pw.add("(min-width: 1200px)", () => {
            document.querySelectorAll('.design-work-wrapper').forEach(item => {
                gsap.set(item.querySelector('.design-work-item-1'), {
                    x: 0,
                    rotate: 0
                });
                gsap.set(item.querySelector('.design-work-item-2'), {
                    x: 0,
                    rotate: 0
                });
                let tl = gsap.timeline({
                ...
                tl.to(item.querySelector('.design-work-item-1'), {
                        x: -400,
                        rotate: -40
                    })
                    .to(item.querySelector('.design-work-item-2'), {
                        x: 400,
                        rotate: 40
                    }, 0);
            });
    ...
    function perspective() {
        ...
        if ($('.tp-perspective-slider').length) {
            ...
            gsap.set('.tp-perspective-slider .tp-perspective-main .tp-perspective-inner', {
                perspective: 60
            });
    ...
    if ($('.tp-brand-inner-area').length) {
        gsap.set(".tp-brand-inner-item img", {
            scale: 1.3,
            opacity: 0
        });
